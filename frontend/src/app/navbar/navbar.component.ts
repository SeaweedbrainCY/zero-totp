...
export class NavbarComponent implements OnInit {
  ...
  get_global_notification() {
    this.http.get(this.apiService.baseURL + "/api/v1/notification/global", { withCredentials: true, observe: 'response' }).subscribe((response) => {
  ...
  get_internal_notification() {
    this.http.get(this.apiService.baseURL + "/api/v1/notification/internal", { withCredentials: true, observe: 'response' }).subscribe((response) => {
      if (response.status == 200) {
        try {
          const data = JSON.parse(JSON.stringify(response.body))
          if (data.display_notification) {
  ...
  get_autolock_delay() {
    return this.http.get(this.apiService.baseURL + "/api/v1/preferences?fields=autolock_delay", { withCredentials: true, observe: 'response' })
  }
