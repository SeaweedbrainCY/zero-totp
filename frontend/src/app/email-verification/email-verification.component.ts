...
export class EmailVerificationComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get(this.apiService.baseURL + "/api/v1/role", { withCredentials: true, observe: 'response' }).subscribe({
      next: (response) => {
        try {
  ...
  verify() {
    ...
    this.http.put(this.apiService.baseURL + "/api/v1/email/verify", data, { withCredentials: true, observe: 'response' }).subscribe({
      next: (response) => {
